...
static void test_iterators()
{
    ...
    LIBRARY::map<int, int>::iterator ite = map.begin();
    assert(ite->first == 0);
    ...
    const LIBRARY::map<int, int> &map2 = map;

    LIBRARY::map<int, int>::const_iterator ite2 = map2.end();
    --ite2;
...
static void test_reverse_iterators()
{
    ...
    LIBRARY::map<int, int>::reverse_iterator ite = map.rbegin();
    assert(ite->first == 90);
    assert(ite->second == 5);
    assert((++ite)->first == 2);
    assert((ite++)->second == 80);
    ...
    LIBRARY::map<int, int>::const_reverse_iterator ite2 = map2.rend();
    --ite2;
...
static void test_range()
{
    ...
    // std::cout << "map begin " << ite->first << std::endl;
    ...
    typedef LIBRARY::map<int, int>::iterator iter;
